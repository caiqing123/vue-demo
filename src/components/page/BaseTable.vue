<template>
    <div class="table">
        ...
        <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="year" label="年份" sortable width="150">
            </el-table-column>
            <el-table-column prop="title" label="名称" width="120">
            </el-table-column>
            <el-table-column  label="标签" :formatter="formatter">
            </el-table-column>
        ...
        computed: {
            data(){
                ...
                return self.tableData.filter(function(d){
                    ...
                    if(!is_del){
                        if(d.title.indexOf(self.select_cate) > -1 &&
                            (d.alt.indexOf(self.select_word) > -1 ||
